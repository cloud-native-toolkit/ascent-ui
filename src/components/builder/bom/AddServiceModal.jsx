...
class ServiceModal extends Component {
    ...
    handleSubmit = (event) => {
        ...
        if (!this.props.isUpdate && this.state.step === 1) {
            ...
            doPostBOM(this.props.archId, this.state.fields).then(res => {
            ...
            doUpdateBOM(this.props.data.id, {
        ...
        return (
            <Grid>
                <Row className="modal-wizard">
                    <Column lg={{span: 12}} md={{span: 12}} sm={{span: 12}}>
                        <ComposedModal
                            ...
                            <ModalBody style={{paddingRight: '1rem'}}>
                                ...
                                { !this.props.isUpdate && this.state.step === 1 &&
                                    <Grid>
                                        <Row>
                                            <Column lg={{span: 2}} md={{span: 12}} sm={{span: 12}}>
                                                <br />
                                                <br />
                                                <CatalogFilter
                                            ...
                                            <Column lg={{span: 10}} md={{span: 12}} sm={{span: 12}}>
                                                <StatefulTileCatalog
