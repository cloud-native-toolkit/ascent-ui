...
import { settings, SimplePagination } from 'carbon-addons-iot-react';
        ...
        <TileGroup
          ...
          tiles={tiles.map((tile) => (
            <RadioTile
              ...
              value={tile.id}
              name={id}
              checked={selectedTileId === tile.id || (isMultiSelect && selectedTileIds.includes(tile.id))}
              onClick={(e) => onSelection(e.target.value)}
